...
\midrule
Actors & Consumer/Professional User, AI Generation System (ComfyUI, Flux2Klein, ControlNet) \\
\midrule
...
\begin{enumerate}[leftmargin=*,noitemsep,topsep=0pt]
    ...
    \begin{itemize}[noitemsep,topsep=0pt]
        ...
        \item \textbf{Flux2Klein:} Applies photorealistic style transformation with structure conditioning
        \item \textbf{Post-processing:} Composes result images and generates furniture recommendations
    \end{itemize}
...
\midrule
Actors & Consumer User, Product Matching System (RF-DETR, SigLIP2, Qwen3-VL), Egyptian Furniture Retailers \\
\midrule
Preconditions & User has generated design (UC-C06), clicks "Shop This Look", retailer catalog populated \\
\midrule
Basic Flow &
\begin{enumerate}[leftmargin=*,noitemsep,topsep=0pt]
    \item \textbf{RF-DETR} detects furniture items and extracts visual crops
    \item \textbf{SigLIP2} extracts high-dimensional visual embeddings for vector search matching
...
\midrule
Technical Notes & 
RF-DETR provides object detection, SigLIP2 enables visual similarity embedding retrieval, and Qwen3-VL generates taxonomy tags for metadata-based filtering. \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
UC-C05: Choose Style/Theme & User selects a design style preset (Modern, Minimalist, Traditional, Mediterranean) before generation. \\
...
UC-M03: Filter by Category/Style & User filters furniture products by category, room type, or style tag. \\
