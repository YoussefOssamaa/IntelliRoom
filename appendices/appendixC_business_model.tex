...
The IntelliRoom Business Model Canvas captures the key elements of our business strategy for the Egyptian interior design and e-commerce market.

\subsection{Key Partners}

\begin{itemize}
    \item Egyptian furniture manufacturers (Mobica, Divano, Danube Home)
    \item Payment gateways (Fawaterk, supporting Fawry, credit cards, and mobile wallets)
...
\begin{itemize}
    \item ComfyUI workflow development and AI pipeline maintenance (Flux2Klein, ControlNet, RF-DETR)
...
\begin{itemize}
    \item AI infrastructure (SAM2, ControlNet, Florence-2, Flux2Klein 4B, RF-DETR, SigLIP2, Qwen3-VL, ComfyUI)
...
\begin{itemize}
    \item AI-powered room redesign powered by Flux2Klein for Egyptian e-commerce integration
...
\begin{itemize}
    ...
    \item \textbf{Premium Tier:} Significantly more generous generation limits, full style preset library, 4K downloads, no watermarks
...
IntelliRoom's core value centers on democratizing interior design for the Egyptian market through: (1) AI-powered spatial redesign via Flux2Klein and ComfyUI workflows, (2) local furniture marketplace integration with EGP pricing, (3) accessibility for middle-class families, (4) Arabic language and local payment support, and (5) community-driven inspiration.
...
Monetization & Months 12-24 & Paid tiers, sustainable revenue, broader Egyptian retailer partnerships \\
\bottomrule
\end{tabular}
\end{table}
...
IntelliRoom's sustainable competitive advantages include: (1) \textbf{Pipeline Moat} --- the Flux2Klein + RF-DETR + SigLIP2 + VDB two-plane architecture is not easily replicable, (2) \textbf{Network Effects} from community-driven content and gallery, (3) \textbf{Local Partnerships} with Egyptian retailers and universities, and (4) \textbf{First-Mover} positioning in AI-powered Egyptian furniture e-commerce.
