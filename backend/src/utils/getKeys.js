...
const adminAuthPrivateKeyPath = path.join(__dirname, "../keys/AdminAuthPrivate.pem");
const adminAuthPublicKeyPath = path.join(__dirname, "../keys/AdminAuthPublic.pem");
...
const adminRefreshPrivateKeyPath = path.join(__dirname, "../keys/AdminRefreshPrivate.pem");
const adminRefreshPublicKeyPath = path.join(__dirname, "../keys/AdminRefreshPublic.pem");
...
const authPrivateKeyPath = path.join(__dirname, "../keys/AuthPrivate.pem");
const authPublicKeyPath = path.join(__dirname, "../keys/AuthPublic.pem");

const authPrivateKey = fs.readFileSync(authPrivateKeyPath, "utf8");
const authPublicKey = fs.readFileSync(authPublicKeyPath, "utf8");

const refreshPrivateKeyPath = path.join(__dirname, "../keys/RefreshPrivate.pem");
const refreshPublicKeyPath = path.join(__dirname, "../keys/RefreshPublic.pem");
...
const resetPrivateKeyPath = path.join(__dirname, "../keys/ResetPrivate.pem");
const resetPublicKeyPath = path.join(__dirname, "../keys/ResetPublic.pem");
