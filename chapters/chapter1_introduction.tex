...
The interior design industry stands at a pivotal transformation point, driven by advances in artificial intelligence and computer vision technologies. While AI-powered design tools have proliferated globally, a critical gap remains: online furniture shoppers cannot visualize products in their own spaces before purchase. This chapter introduces IntelliRoom, an AI-powered interior design platform specifically developed to address this visualization gap in the Egyptian e-commerce market through spatial intelligence and direct furniture marketplace integration.

% ============================================================================
\section{Problem Statement}
\label{sec:problem_statement}

The global interior design technology market has witnessed remarkable growth, expanding from USD 18.32 billion in 2024 toward projected valuations exceeding USD 184 billion by 2032. Despite this growth, a critical practical barrier persists for Egyptian homeowners and online furniture shoppers: the inability to visualize furniture in their actual living spaces before purchase.

Online furniture retailers in Egypt report cart abandonment rates exceeding 90\%---far above the e-commerce average of 70--75\%---driven primarily by insufficient visualization tools. Meanwhile, professional interior design consultations cost 500--2,000 EGP per room, making them inaccessible to most households.

Existing AI interior design platforms such as COOHOM, Interior AI, RoomGPT, and Spacely AI offer generative capabilities but fail to address the core Egyptian market needs:

\begin{itemize}
    \item No integration with Egyptian furniture retailers or local pricing in EGP
    \item No direct connection between AI-generated designs and purchasable products
    \item No support for Egyptian payment methods (Fawry, InstaPay)
    \item No e-commerce checkout or order management workflow
\end{itemize}

This visualization-to-purchase gap creates a substantial commercial opportunity for a platform that connects AI-powered spatial redesign directly to the Egyptian furniture marketplace.

% ============================================================================
\section{Project Objectives}
\label{sec:objectives}

The IntelliRoom platform aims to bridge the gap between AI-powered spatial design and Egyptian e-commerce integration through the following objectives:

\subsection{Primary Objectives}

\begin{enumerate}
    \item \textbf{Develop an AI-powered spatial redesign engine} powered by Flux2Klein 4B for high-fidelity room transformations, with SAM2 for precision segmentation, ControlNet for structure-preserving generation, and Florence-2 for room analysis, all orchestrated through ComfyUI workflows.
    
    \item \textbf{Implement an advanced AI furniture retrieval pipeline} using RF-DETR for furniture detection, SigLIP2 for visual embeddings, Qwen3-VL for taxonomy tagging, and ChromaDB for vector similarity search.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|l|X|}
        ...
        \begin{itemize}[nosep,leftmargin=*]
            ...
            \item Style transformation engine with Flux2Klein generative workflows
            ...
            \item Complete shopping cart, order registration, and subscription checkout with Fawaterk
        \end{itemize} \\
        \hline
        \textbf{Out of Scope} & 
        \begin{itemize}[nosep,leftmargin=*]
            \item Direct payment processing for physical furniture purchases (handled via retailer affiliate links)
