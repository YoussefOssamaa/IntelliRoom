...
\begin{longtable}{|p{1.2cm}|p{2.8cm}|p{5.4cm}|p{1.5cm}|p{1.8cm}|}
    ...
    \hline
    FR-02 & Authentication & The system shall support social login via Google and Facebook & Medium & Complete \\
    \hline
    FR-03 & Authentication & The system shall implement secure password recovery via email & High & Complete \\
    \hline
    ...
    \hline
    FR-07 & Room Upload & The system shall validate image quality and provide feedback on unsuitable uploads & High & Complete \\
    \hline
    FR-08 & Room Upload & The system shall support direct camera capture from mobile devices & Medium & Planned \\
    \hline
    FR-09 & Room Analysis & The system shall automatically detect room type (bedroom, living room, kitchen, etc.) & High & Complete \\
    \hline
    FR-10 & Room Analysis & The system shall identify existing furniture items in uploaded photographs & High & Complete \\
    \hline
    FR-11 & Room Analysis & The system shall analyze current room style and provide style classification & Medium & Complete \\
    \hline
    FR-12 & Style Selection & The system shall offer predefined style presets including Arabic Traditional, Modern Egyptian, Mediterranean, and Contemporary & High & Complete \\
    \hline
    FR-13 & Style Selection & The system shall allow mood-based design preferences (cozy, minimalist, luxurious) & Medium & Complete \\
    \hline
    FR-14 & AI Generation & The system shall generate 3-5 design variations for each request & High & Complete \\
    \hline
    ...
    \hline
    FR-17 & Visualization & The system shall provide before/after comparison with interactive slider & High & Complete \\
    \hline
    FR-18 & Visualization & The system shall support zoom and detail inspection of generated designs & Medium & Complete \\
    \hline
    ...
    \hline
    FR-21 & 3D Visualization & The system shall convert 2D layouts to 3D visualization & Low & Complete \\
    \hline
    ...
    \hline
    FR-27 & Credits & The system shall support subscription purchase via Fawaterk (supporting Fawry, cards, and wallets) & Medium & Complete \\
    \hline
    ...
    \hline
    FR-30 & Export & The system shall enable high-resolution download of generated designs & High & Complete \\
    \hline
    FR-31 & Export & The system shall generate PDF reports with furniture specifications & Medium & Complete \\
    \hline
...
This section presents the primary use cases that define user interactions with the IntelliRoom system. Figure~\ref{fig:uc_overview} provides a high-level overview of user roles and their access to system capabilities. The following subsections illustrate the five most critical use cases in detail; complete use case documentation is provided in Appendix~\ref{app:use_cases}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/6_use_cases.png}
    \caption{System Use Case Overview: Guest and Registered User roles mapped to E-Commerce, Community, and AI Design capabilities.}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|p{3.5cm}|p{1.5cm}|p{1.8cm}|p{1.8cm}|p{1.5cm}|X|}
        ...
        \hline
        Room Upload & 3 & 2 & 0 & 1 & 67\% \\
        \hline
        Room Analysis & 3 & 3 & 0 & 0 & 100\% \\
        \hline
        Style Selection & 2 & 2 & 0 & 0 & 100\% \\
        \hline
        AI Generation & 3 & 3 & 0 & 0 & 100\% \\
        \hline
        Visualization & 2 & 2 & 0 & 0 & 100\% \\
        \hline
        2D/3D Planning & 3 & 3 & 0 & 0 & 100\% \\
        \hline
        ...
        \hline
        Plugin Market & 4 & 4 & 0 & 0 & 100\% \\
        \hline
        Contact & 1 & 1 & 0 & 0 & 100\% \\
        \hline
        \textbf{Overall} & \textbf{43} & \textbf{41} & \textbf{0} & \textbf{2} & \textbf{95\%} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{User Authentication \& Security:} Asymmetric JWT (RS256) authentication with separate public/private key pairs for auth and refresh tokens, httpOnly secure cookie sessions, refresh token rotation tracked in MongoDB, Zod input validation schemas, bcrypt password hashing, and automated monthly credit reset logic for free-tier users
    ...
    \item \textbf{AI Vector Recommendation Engine:} Two-plane architecture with a local FastAPI orchestrator (ChromaDB vector store, semantic taxonomy snapper) and a remote GPU inference server (RF-DETR for detection, SigLIP2 for embeddings, Qwen3-VL 4B for taxonomy tagging) connected via zrok tunneling
    \item \textbf{Community Features:} Gallery post schema with likes, comments, and tags support
    \item \textbf{Credit System:} User credits, transaction tracking, and subscription plan support (free, monthly, yearly) with automated monthly reset
    \item \textbf{Visualization Module:} Interactive before/after comparison tools and multi-level zoom inspection features for high-resolution AI-generated design variations
    \item \textbf{Export Engine:} High-resolution image downloader and PDF report generator for furniture specification details
...
\begin{itemize}
    \item \textbf{Frontend UI:} React.js structure established; component implementation ongoing across multiple screens
\end{itemize}
