...
\begin{longtable}{|p{2cm}|p{4cm}|p{6.5cm}|}
    ...
    \hline
    POST & /api/auth/login & User login with JWT (RS256) cookie session \\
    \hline
    POST & /api/auth/register & User registration with bcrypt password hashing \\
    \hline
    POST & /api/auth/refresh & Refresh expired auth token using refresh cookie \\
    \hline
    ...
    \hline
    \multicolumn{3}{|c|}{\textbf{Administrative Routes (/api/admin)}} \\
    \hline
    GET & /users & List all registered users (admin only) \\
    \hline
    GET & /logs & View system and authentication logs \\
    \hline
    GET & /plans & Manage available pricing plans \\
    \hline
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|p{4cm}|p{2cm}|X|}
        ...
        \hline
        Frontend UI & Partial & React app structure, routing, multiple screens implemented \\
        \hline
