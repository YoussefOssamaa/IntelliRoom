...
import _doorPng from './door.png';
import _doorMtl from './door.mtl';
import _doorObj from './door.obj';
import _textureJpg from './texture.jpg';
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cached3DDoor) {
      return Promise.resolve(onLoadItem(deepCloneWithMaterials(cached3DDoor)));
    }
    ...
    return loadObjWithMaterial(mtl, obj, img.substring(0, img.lastIndexOf('/') + 1))
      .then(object => {
        cached3DDoor = object;
        return onLoadItem(deepCloneWithMaterials(cached3DDoor))
      })
