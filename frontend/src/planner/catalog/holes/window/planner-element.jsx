...
import _windowPng from './window.png';
import _windowMtl from './window.mtl';
import _windowObj from './window.obj';
import _texturePng from './texture.png';

let cached3DWindow = null;

// Helper to deep clone with materials
function deepCloneWithMaterials(object) {
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cached3DWindow) {
      return Promise.resolve(onLoadItem(deepCloneWithMaterials(cached3DWindow)));
    }
    ...
    return loadObjWithMaterial(mtl, obj, img.substring(0, img.lastIndexOf('/') + 1))
      .then(object => {
        ...
        return onLoadItem(deepCloneWithMaterials(cached3DWindow))
      })
  }
};
