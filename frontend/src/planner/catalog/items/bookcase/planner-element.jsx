...
import _woodJpg from './wood.jpg';
import _bookTexture1Jpg from './bookTexture1.jpg';
import _bookTexture2Jpg from './bookTexture2.jpg';
import _bookTexture3Jpg from './bookTexture3.jpg';
import _bookcasePng from './bookcase.png';
...
const woodMaterial=textureLoader.load(_woodJpg);
const bookTexture1=textureLoader.load(_bookTexture1Jpg);
const bookTexture2=textureLoader.load(_bookTexture2Jpg);
const bookTexture3=textureLoader.load(_bookTexture3Jpg);
...
function  makeObjectMinLOD() {
  ...
  let woodMaterial=textureLoader.load(_woodJpg);
