...
import _texturePanelPng from './texturePanel.png';
import _electricalPanelPng from './electricalPanel.png';
...
function makeObjectMaxLOD(newWidth,newHeight,newDepth) {
  ...
  let mat = textureLoader.load(_texturePanelPng);
