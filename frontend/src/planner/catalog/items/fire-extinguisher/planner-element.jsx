...
import _gageImagePng from './gage-image.png';
import _labelImagePng from './label-image.png';
import _fireExtinguisherPng from './fire-extinguisher.png';
...
function makeObjectMaxLOD() {
  ...
  const gageImage = textureLoader.load(_gageImagePng);
  ...
  const labelImage = textureLoader.load(_labelImagePng);
