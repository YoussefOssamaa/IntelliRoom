...
import _steelJpg from './steel.jpg';
import _darksteelJpg from './darksteel.jpg';
import _logoJpg from './logo.jpg';
import _kitchenPng from './kitchen.png';
...
let steel = textureLoader.load(_steelJpg);
let darkSteel = textureLoader.load(_darksteelJpg);
let logo = textureLoader.load(_logoJpg);
