...
import _display1Png from './display1.png';
import _display2Png from './display2.png';
import _metalDetectorPng from './metalDetector.png';
...
function makeObjectMaxLOD() {
  ...
  let display1= textureLoader.load(_display1Png);
  let display2= textureLoader.load(_display2Png);
