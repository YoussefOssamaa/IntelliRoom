...
import _powerJpg from './power.jpg';
import _blackJpg from './black.jpg';
import _whiteJpg from './white.jpg';
import _keyboardJpg from './keyboard.jpg';
import _monitorPCPng from './monitorPC.png';
...
const power    = textureLoader.load(_powerJpg);
const black    = textureLoader.load(_blackJpg);
const white    = textureLoader.load(_whiteJpg);
const keyboard = textureLoader.load(_keyboardJpg);
