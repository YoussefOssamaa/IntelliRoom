...
import _recyclingBinsPng from './recycling-bins.png';
import _recyclePng from './recycle.png';
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    let makeBin = (color) => {
      ...
      var planeMaterial2 = new Three.MeshLambertMaterial({ transparent: true, color: 0xffffff, map: null });
      
      // Load texture and assign in callback
      new Three.TextureLoader().load(_recyclePng, (texture) => {
        planeMaterial2.map = texture;
