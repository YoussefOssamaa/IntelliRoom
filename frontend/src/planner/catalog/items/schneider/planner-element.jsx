...
import _monitorPng from './monitor.png';
import _schneiderPng from './schneider.png';
...
let lcdMaterial = new Three.MeshLambertMaterial({ transparent: true, color: 0xffffff, map: null });

// Load texture and assign in callback
textureLoader.load(_monitorPng, (texture) => {
  lcdMaterial.map = texture;
...
function makeObjectMaxLOD(){
  ...
  let lcd = new Three.Mesh(planeGeometryFront, lcdMaterial.clone());
