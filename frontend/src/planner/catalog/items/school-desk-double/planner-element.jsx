...
import _schoolDeskDoublePng from './school-desk-double.png';
...
//      material = new Three.MeshLambertMaterial({color: 0x9b8c75});
      let texture = new Three.TextureLoader().load(_woodJpg);
    ...
    // Modern Three.js accepts array of materials directly
