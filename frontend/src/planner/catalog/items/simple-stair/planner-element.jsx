...
import simpleStairImg from './simple-stair.png';
import whitePaintTexture from './textures/white-paint.jpg';
import marbleTexture from './textures/marble.jpg';
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    loader.load(whitePaintTexture, (texture) => {
      texture.wrapS = Three.RepeatWrapping;
      texture.wrapT = Three.RepeatWrapping;
      texture.repeat.set(stepWidth * whitePaintTextureRepeatFactor, stepHeight * whitePaintTextureRepeatFactor);
      stepPlaneMaterial.map = texture;
    ...
    loader.load(whitePaintTexture, (texture) => {
      texture.wrapS = Three.RepeatWrapping;
      texture.wrapT = Three.RepeatWrapping;
      texture.repeat.set(numberOfSteps * stepDepth * whitePaintTextureRepeatFactor,
        numberOfSteps * stepHeight * whitePaintTextureRepeatFactor);
      stairProfileMaterial.map = texture;
    ...
    stairProfileMaterial2.map = loader.load(whitePaintTexture);
    ...
    loader.load(whitePaintTexture, (texture) => {
      texture.wrapS = Three.RepeatWrapping;
      texture.wrapT = Three.RepeatWrapping;
      texture.repeat.set(stairClosure1Width * whitePaintTextureRepeatFactor,
        stairClosure1Height * whitePaintTextureRepeatFactor);
      closure1Material.map = texture;
...
let buildStepCover = (width, height, depth) => {
  ...
  loader.load(marbleTexture, (texture) => {
    texture.wrapS = Three.RepeatWrapping;
    texture.wrapT = Three.RepeatWrapping;
