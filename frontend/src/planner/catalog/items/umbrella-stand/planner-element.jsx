...
import _bronzeTextureJpg from './bronze-texture.jpg';
import _umbrellaStandPng from './umbrellaStand.png';
...
const material = new Three.MeshLambertMaterial({ color: 0xffffff, map: null });

// Load texture and assign in callback
textureLoader.load(_bronzeTextureJpg, (texture) => {
