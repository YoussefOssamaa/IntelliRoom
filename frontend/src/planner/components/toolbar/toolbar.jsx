...
import ToolbarLanguageButton from './toolbar-language-button';
...
export default class Toolbar extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return this.props.state.mode !== nextProps.state.mode ||
      ...
      this.state.languageKey !== nextState.languageKey;
  }
  ...
  render() {
    ...
    let sorter = [
      ...
      },
      {
        ...
        dom: <ToolbarLanguageButton onLanguageChange={() => this.forceUpdate()} />
      }
    ];
...
Toolbar.contextType = PlannerContext;
