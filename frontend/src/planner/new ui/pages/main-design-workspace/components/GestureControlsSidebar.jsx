  ...
  const gestureCards = [
    {
      ...
      description:
        'Use one pinched hand to control the 3D room. Move the pinched hand left and right to rotate, and closer or farther from the camera to zoom.',
    },
    {
      ...
      <div className="gesture-sidebar-content">
          ...
          <div>
            ...
            <p>
              {workspaceMode === '2d'
                ...
                : t(
                    'Turn on gesture control, allow camera access, then use one pinched hand to rotate and zoom.',
                  )}
            </p>
          </div>
        </div>
        ...
        <div className="gesture-help-card">
          ...
          <ol className="gesture-help-list">
            ...
            <li>{t('Keep the same pinched hand held and move it closer to the camera to zoom in, or farther away to zoom out.')}</li>
          </ol>
        </div>
      </div>
    </div>
