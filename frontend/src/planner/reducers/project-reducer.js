...
export default function (state, action) {
  ...
  switch (action.type) {
    ...
    case SET_PROPERTIES:
      state = state.merge({ sceneHistory: history.historyPush(state.sceneHistory, state.scene), redoStack: new List() });
    ...
    case UPDATE_VIEW_CENTER:
      return Project.updateViewCenter(state, action.viewCenter).updatedState;
