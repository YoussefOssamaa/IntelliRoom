export default {
  ...
  "Drag Pan (Default)": "Drag Pan (Default)",
  "Pointer Lock Look": "Pointer Lock Look",
  ...
  "Search finishes": "Search finishes",
  "Filter finish placement": "Filter finish placement",
  "Click a {0} in 3D view to apply \"{1}\".": "Click a {0} in 3D view to apply \"{1}\".",
  "Select a finish, then click a wall side or floor in 3D view.": "Select a finish, then click a wall side or floor in 3D view.",
  "No finishes available yet": "No finishes available yet",
  "Once finishes are available in MongoDB, they will show up here automatically.": "Once finishes are available in MongoDB, they will show up here automatically.",
  "by": "by",
  "votes": "votes",
  "Snap": "Snap",
  "Point": "Point",
  ...
  "Camera Vertical Rotation": "Camera Vertical Rotation",
  ...
  "Selected Capture Preview": "Selected Capture Preview",
  "Close preview": "Close preview",
  "Captured image thumbnail": "Captured image thumbnail",
  ...
  "Capture a frame to generate a room summary.": "Capture a frame to generate a room summary.",
  "No visible items were detected in this frame.": "No visible items were detected in this frame.",
  "Render ready.": "Render ready.",
  "Failed to capture current frame": "Failed to capture current frame",
  "Resolution": "Resolution",
  "Collapse resolution panel": "Collapse resolution panel",
  "Collapse smart viewer panel": "Collapse smart viewer panel",
  "Smart Viewer": "Smart Viewer",
  "Collapse camera and captures panel": "Collapse camera and captures panel",
  "Camera Properties": "Camera Properties",
  "Bedroom": "Bedroom",
