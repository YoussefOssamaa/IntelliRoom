...
\newcommand{\projecttitle}{IntelliRoom: AI-Powered Interior Design Platform with Spatial Intelligence and Egyptian E-Commerce Integration}
...
\cleardoublepage
\begin{appendices}
\input{appendices/appendixA_market_analysis}
\input{appendices/appendixB_use_cases}
\input{appendices/appendixC_business_model}
\input{appendices/appendixD_ui_mockups}
\end{appendices}
